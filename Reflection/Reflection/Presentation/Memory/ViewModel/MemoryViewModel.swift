...
final class MemoryViewModel: ObservableObject {
    ...
    @Published private(set) var specificColorChipMemories: [Memory] = []
    ...
    func updateMemory(_ memory: Memory) {
        guard let specificColorChip = self.specificColorChip else {return}
        self.memoryUseCase.updateMemory(memory)
            ...
            .sink { completion in
                ...
                self.fetchSpecificColorChipMemories(specificColorChip)
            }
            .store(in: &self.cancellables)
    }
    ...
    func fetchSpecificColorChipMemories(_ colorChip: ColorChip) {
        ...
        self.colorChipUseCase.fetchSpecificColorChip(colorChip)
            ...
            .sink { completion in
                ...
                Log.d(self.specificColorChipMemories)
            }
            .store(in: &self.cancellables)
    }
